<div class="panel panel-info">
	<div class="panel-heading">
  	...
  	<div class="panel-body">
  		<g:formRemote role="form" name="formGrupo" update="informacion" url="[controller: 'mundial', action:'obtenerPartidos']" before="\$(document).find('.loading').show()" onComplete="\$(document).find('.loading').hide()">
